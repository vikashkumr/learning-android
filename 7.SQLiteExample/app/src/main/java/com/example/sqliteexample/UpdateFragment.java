...
public class UpdateFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        Update_id = view.findViewById(R.id.id_contact_update);
        Update_name = view.findViewById(R.id.name_contact_update);
        Update_email = view.findViewById(R.id.id_contact_delete);
        Update_bn = view.findViewById(R.id.bn_save_delete);
